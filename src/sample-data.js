export const SAMPLE_DATA = [
  ...
  },
  {
      ...
      "contents": "3. Creating a 1071 submission file The following information describes the format used when filing HMDA data with the Bureau.",
      "link": "#3"
  },
  {
      "id": 6,
  ...
  },
  {
      ...
      "contents": "Field 2: Application Date Required for all loan/application records. Instructions Enter, in numeral form, the date the application was received or the date shown on the application form by year, month, and day, using YYYYMMDD format. Field type: Date Example\nFor July 21, 2024, enter 20240721\nValidations\nMust be in numeral form in YYYYMMDD format\nMust not be left blank",
      "link": "#4.2.1"
  },
  {
      "id": 13,
      "title": "4.3. Application Method",
      "contents": "4.3. Application Method Rule Section: 107(a)(3) Application Method",
      "link": "#4.3"
  },
  {
      "id": 14,
      "title": "Field 3: Application Method",
      "contents": "Field 3: Application Method Required for all loan/application records. Instructions Indicate the means by which the applicant submitted the application by entering a code from the specified list of values. Field type: Choice Valid values \t Codes  \n1 \t Code 1 - In-person  \n2 \t Code 2 - Telephone  \n3 \t Code 3 - Online  \n4 \t Code 4 - Mail Validations\nMust equal 1, 2, 3 or 4\nMust not be left blank",
      "link": "#4.3.1"
  },
  {
      "id": 15,
      "title": "4.4. Application Recipient",
      "contents": "4.4. Application Recipient Rule Section: 107(a)(4) Application Recipient",
      "link": "#4.4"
  },
  {
      "id": 16,
      "title": "Field 4: Application Recipient",
      "contents": "Field 4: Application Recipient Required for all loan/application records. Instructions Indicate the application recipient by entering a code from the specified list of values. Field type: Choice Valid values \t Codes  \n1 \t Code 1 – The applicant submitted the application directly to the FI or its affiliate  \n2 \t Code 2 – The applicant submitted the application indirectly to the FI via a third party  Validations\nMust equal 1 or 2\nMust not be left blank",
      "link": "#4.4.1"
  },
  {
      "id": 17,
      "title": "4.5. Credit Type",
      "contents": "4.5. Credit Type Rule Section: 107(a)(5) Credit Type\nCredit Product\nFree Form Text Field for Other Credit Products\nType of Guarantee\nFree Form Text Field for Other Guarantee\nLoan Term: N/A Flag\nLoan Term",
      "link": "#4.5"
  },
  {
      "id": 18,
      "title": "Field 5: Credit Product",
      "contents": "Field 5: Credit Product Required for all loan/application records. Instructions Indicate the credit product by entering a code from the specified list of values. Field type: Choice Valid values \t Codes \t Instructions  \n1 \t Code 1 - Term loan—unsecured  \t  \n2 \t Code 2 - Term loan—secured \t  \n3 \t Code 3 - Line of credit—unsecured \t  \n4 \t Code 4 - Line of credit—secured \t  \n5 \t Code 5 - Credit card \t  \n6 \t Code 6 - Merchant cash advance  \t  \n7 \t Code 7 - Other sales-based financing transaction  \t  \n8 \t Code 8 – Other (specify in text below)  \t  \n88 \t  Code 88 - Not provided by applicant and otherwise undetermined  \t  Enter Code 88 if the credit product is not provided by applicant and is otherwise undetermined  Validations\nMust equal 1, 2, 3, 4, 5, 6, 7, 8, or 88\nMust not be left blank",
      "link": "#4.5.1"
  },
  {
      "id": 19,
      "title": "Field 6: Free Form Text Field for Other Credit Products",
      "contents": "Field 6: Free Form Text Field for Other Credit Products Required if Credit Type: Credit Product is Code 8. Leave blank if Code 8 is not entered. Instructions Specify in text the Other Credit Product if Code 8 is entered. Field type: Text Validations\nMust be in text form.",
      "link": "#4.5.2"
  },
  {
      "id": 20,
  ...
  },
  {
      ...
      "contents": "Field 16: Action Taken Required for all loan/application records. Instructions Indicate whether the application was Originated, Approved but not accepted, Denied, Withdrawn by applicant, or Incomplete by entering a code from the specified list. Valid values \t Codes  \n1 \t Code 1 - Originated   \n2 \t Code 2 - Approved but not accepted   \n3 \t Code 3 - Denied   \n4 \t Code 4 - Withdrawn by applicant   \n5 \t  Code 5 - Incomplete Validations\nMust equal 1, 2, 3, 4, or 5.\nMust not be left blank.",
      "link": "#4.9.1"
  },
  {
      "id": 34,
  ...
  },
  {
      ...
      "contents": "4.12. Pricing information Rule Section: 107(a)(12) Fixed rate transaction\nInterest rate: N/A flag\nInterest rate\n \nTotal origination charges\nN/A flag\nTotal origination charges\nVariable rate transaction\nMargin: N/A flag\nMargin\nIndex name\nIndex name: Other\nIndex value: N/A flag\nIndex value\n \nAmount of total\nBroker fees\nNon-interest charges to be imposed over the first annual period",
      "link": "#4.12"
  },
  {
      "id": 40,
      "title": "Field 20: Fixed rate: Interest rate: N/A flag",
      "contents": "Field 20: Fixed rate: Interest rate: N/A flag Required for all loan/application records. Instructions Indicate whether the Fixed rate: Interest rate data element is applicable by entering a code from the specified list of values. Field type: Choice Valid values \t Codes \t Instructions  \n0 \t Code 0 - Applicable \t  \n99 \t Code 99 - Not applicable \t Enter Code 99 if: The application is denied, withdrawn, or incomplete, or\nThe approved loan is not fixed rate\nValidations\nMust equal 0 or 99\nMust not be left blank",
      "link": "#4.12.1"
  },
  {
      "id": 41,
  ...
  },
  {
      ...
      "contents": "Field 22: Variable rate transaction: Margin: N/A flag Required for all loan/application records. Instructions Indicate whether the Variable rate transaction: Margin data element is applicable by entering a code from the specified list of values. Field type: Choice Valid values \t Codes \t Instructions  \n0 \t Code 0 - Applicable \t  \n1 \t Code 1 - Not applicable \t Enter Code 1 if: The application is denied, withdrawn, or incomplete, or\nThe transaction has no interest rate, or\nThe approved loan is not variable rate\nValidations\nMust equal 0 or 1\nMust not be left blank",
      "link": "#4.12.3"
  },
  {
      "id": 43,
  ...
  },
  {
      ...
      "contents": "Field 25: Variable rate transaction: Index name: Other Conditionally required if Field 24: Variable rate transaction: Index name is Code 9. Leave blank if Code 9 is not entered. Instructions Specify in text the Other Index Name if Code 9 is entered. Field type: Text Validations\nMust not exceed 100 characters in length.",
      "link": "#4.12.6"
  },
  {
      "id": 46,
  ...
  {
      "id": 49,
      "title": "Field 29: Amount of Total Non-Interest Charges to be Imposed Over the First Annual Period",
  ...
  {
      "id": 50,
      "title": "Field 30: MCA: Difference Between Amount Advanced and Amount to be Repaid: N/A Flag",
  ...
  {
      "id": 51,
      "title": "Field 31: MCA: Difference Between Amount Advanced and Amount to be Repaid",
  ...
  },
  {
      ...
      "contents": "Field 36: Gross Annual Revenue: NP Flag Required for all loan/application records. Instructions Indicate whether GAR is provided by entering a code from the specified list of values. Field Type: Choice Valid values \t Codes \t Instructions  \n0 \t Code 0 – Provided   \t  \n88 \t Code 88 – Not Provided \t Enter Code 88 if GAR is not provided by applicant and is otherwise undetermined. Validations\nMust equal 0 or 88\nMust not be left blank",
      "link": "#4.14.1"
  },
  {
      "id": 59,
      "title": "Field 37: Gross Annual Revenue",
      "contents": "Field 37: Gross Annual Revenue Conditionally required if Field 37: NP Flag is Code 0. Leave blank if Code 0 is not entered. Instructions Enter the dollar amount of the applicant’s Gross Annual Revenue (GAR) during its last fiscal year prior to when the information is collected. Field Type: Numeric Example\nIf $855,430, enter 855430 or 855430.00\nIf $855,430.17, enter 855430.17\nIf $0, enter 0\nValidations\nIf present, must be in numeric form",
      "link": "#4.14.2"
  },
  {
      "id": 60,
      "title": "4.15. North American Industry Classification System (NAICS) Code",
      "contents": "4.15. North American Industry Classification System (NAICS) Code Rule Section: 107(a)(15)",
      "link": "#4.15"
  },
  {
      "id": 61,
      "title": "Field 38: North American Industry Classification System (NAICS) Code: NP Flag",
      "contents": "Field 38: North American Industry Classification System (NAICS) Code: NP Flag Required for all loan/application records. Instructions Indicate whether NAICS Code is provided by entering a code from the specified list of values. Field Type: Choice Valid values \t Codes \t Instructions  \n0 \t Code 0 – Provided \t  \n88 \t Code 88 – Not Provided \t Enter Code 88 if NAICS Code is not provided by applicant and is otherwise undetermined. Validations\nMust equal 0 or 88\nMust not be left blank",
      "link": "#4.15.1"
  },
  {
      "id": 62,
  ...
  },
  {
      ...
      "contents": "Field 40: Number of Workers: NP Flag Required for all loan/application records. Instructions Indicate whether Number of Workers is provided by entering a code from the specified list of values. Field Type: Choice Valid values \t Codes \t Instructions  \n0 \t Code 0 – Provided \t  \n88 \t Code 88 – Not Provided \t Enter Code 88 if Number of Workers is not provided by applicant and is otherwise undetermined. ",
      "link": "#4.16.1"
  },
  {
      "id": 65,
  ...
  },
  {
      ...
      "contents": "Field 42: Time in Business: Type of Response Required for all loan/application records. Instructions Indicate whether the applicant provided information on Time in Business by entering a code from the specified list of values. Field Type: Choice Valid values \t Codes  \n1 \t Code 1 – Time in Business is provided by applicant  \n2 \t Code 2 – Applicant has been in business less than one year  \n3 \t Code 3 – Applicant has not started business yet  \n88 \t Code 88 – Time in Business is not provided by applicant and is otherwise undetermined by the lender  Validations\nMust equal 1, 2, 3, or 88\nMust not be left blank",
      "link": "#4.17.1"
  },
  {
      "id": 68,
  ...
  },
  {
      ...
      "contents": "Field 44: Minority-Owned Business Status: Status Required for all loan/application records. Instructions Indicate whether the applicant is a minority-owned business by entering a code from the specified list of values. Field Type: Choice Valid values \t Codes  \n1 \t Code 1 – Yes  \n2 \t Code 2 – No  \n3 \t Code 3 – The applicant responded that they did not wish to provide this information  \n4 \t Code 4 – The applicant did not respond Validations\nMust equal 1, 2, 3, or 4\nMust not be left blank",
      "link": "#4.18.1"
  },
  {
      "id": 71,
      "title": "Field 45: Minority-owned Business Status: Previously Collected Data",
  ...
  },
  {
      ...
      "contents": "Field 46: Women-Owned Business Status: Status Required for all loan/application records. Instructions Indicate whether the applicant is a women-owned business by entering a code from the specified list of values. Field Type: Choice Valid values \t Codes  \n1 \t Code 1 – Yes  \n2 \t Code 2 – No  \n3 \t Code 3 – The applicant responded that they did not wish to provide this information  \n4 \t Code 4 – The applicant did not respond Validations\nMust equal 1, 2, 3, or 4\nMust not be left blank",
      "link": "#4.19.1"
  },
  {
      "id": 74,
  ...
  },
  {
      ...
      "contents": "Field 48: Number of Principal Owners: NP Flag Required for all loan/application records. Instructions Indicate whether Number of Principal Owners is provided by entering a code from the specified list of values. Field Type: Choice Valid values \t Codes \t Instructions  \n0 \t Code 0 – Provided \t  \n88 \t Code 88 – Not Provided \t Enter Code 88 if Number of Principal Owners is not provided by applicant and is otherwise undetermined. Validations\nMust equal 0 or 88\nMust not be left blank",
      "link": "#4.20.1"
  },
  {
      "id": 77,
  ...
  },
  {
      ...
      "contents": "4.21. Visual Observation and/or Surname Rule Section: 107(a)(20)",
      "link": "#4.21"
  },
  {
      "id": 79,
  ...
  {
      "id": 81,
      "title": "Field 51: Previously Collected Data for Ethnicity, Race, or Sex, of Principal Owner(s)",
  ...
  {
      "id": 84,
      "title": "Field 53: Ethnicity of Principal Owner 1: Free Form Text Field for Other Hispanic or Latino",
  ...
  {
      "id": 87,
      "title": "Field 55: Race of Principal Owner 1: Free Form Text Field for American Indian or Alaska Native Enrolled or Principal Tribe",
  ...
  {
      "id": 88,
      "title": "Field 56: Race of Principal Owner 1: Free Form Text Field for Other Asian",
  ...
  {
      "id": 89,
      "title": "Field 57: Race of Principal Owner 1: Free Form Text Field for Other Black or African American",
  ...
  {
      "id": 90,
      "title": "Field 58: Race of Principal Owner 1: Free Form Text Field for Other Pacific Islander",
  ...
  {
      "id": 93,
      "title": "Field 60: Sex of Principal Owner 1: Free Form Text Field for I Prefer to Self-Identify",
      "contents": "Field 60: Sex of Principal Owner 1: Free Form Text Field for I Prefer to Self-Identify Conditionally required if Principal Owner Sex is Code 5. Leave blank if Code 5 is not entered. Instructions Specify in text Principal Owner: 1’s self-identified sex if provided. Field Type: Text Example\nNonbinary\nValidations\nIf present, must be in text form with a width of up to 100 characters",
      "link": "#4.25.2"
  },
  {
      "id": 94,
      "title": "4.26. Principal Owner 2",
      "contents": "4.26. Principal Owner 2 Race/sex/ethnicity data for Principal Owner 2. Rule section 107(a)(20)",
      "link": "#4.26"
  },
  {
      "id": 95,
      "title": "Field 61: Ethnicity of Principal Owner: 2",
      "contents": "Field 61: Ethnicity of Principal Owner: 2 Conditionally required if there are at least two principal owners. Leave blank if the applicant has fewer than two principal owners. Instructions See Field 52: Ethnicity of Principal Owner 1",
      "link": "#4.26.1"
  },
  {
      "id": 96,
      "title": "Field 62: Ethnicity of Principal Owner 2: Free Form Text Field for Other Hispanic or Latino",
  ...
  },
  {
      ...
      "contents": "Field 63: Race of Principal Owner: 2 Conditionally required if there are at least two Principal Owners. Leave blank if applicant has only one principal owner Instructions See Field 54: Race of Principal Owner: 1",
      "link": "#4.26.3"
  },
  {
      "id": 98,
      "title": "Field 64: Sex of Principal Owner: 2",
      "contents": "Field 64: Sex of Principal Owner: 2 Conditionally required if there are at least two Principal Owners. Leave blank if applicant has only one principal owner Instructions See Field 55: Sex of Principal Owner: 1",
      "link": "#4.26.4"
  },
  {
      "id": 99,
      "title": "5. Data validation",
      "contents": "5. Data validation This section will describe the validation process and explain its purpose.",
      "link": "#5"
  },
  {
      "id": 100,
  ...
  },
  {
      ...
      "contents": "5.2. List of validations What will this section look like? Not sure yet. We'll need a way to make it visually make sense to vendors and compliance officers. It will probably have a lot of information, so we may find another way to break it into sections.",
      "link": "#5.2"
  },
  {
      "id": 102,
      "title": "6. Where to get help",
      "contents": "6. Where to get help CFPB will provide regulatory implementation resources for filers and vendors, called 1071 Help. We will decide how to guide people to those resources in the future. There might be a list of resources and their descriptions here. Such as: FAQ about the data collection\nResources specific to small filers\nGuides for reporting various loan scenarios?\nContact info for the 1071 Help function",
      "link": "#6"
  },
  {
      "id": 103,
